...
- **Release packaging** — `python/mnemix/_version.py` as canonical version source, tightened `pyproject.toml` metadata, `twine check` CI validation step, `scripts/check-python-package.sh` local pre-publish script, and `docs/pypi-release-plan.md`.
