...
This adapter bridges the AI DX Toolkit memory event model to the Temporal Plane
Python client.  It depends only on the public ``temporal_plane`` package API and
...
class TemporalPlaneAdapter:
    """Adapter that maps AI DX Toolkit memory events to Temporal Plane operations.
    ...
    All operations delegate to :class:`~temporal_plane.TemporalPlane`; no
    ...
    def __init__(self, store: Path | str = Path(".temporal-plane")) -> None:
        self._client = TemporalPlane(store=Path(store))
    ...
    def record_observation(
        ...
        *,
        ...
        Returns:
            The persisted :class:`~temporal_plane.models.MemoryDetail`.
        """
    ...
    def fetch_context(
        ...
        *,
        ...
        Returns:
            A flat list of :class:`~temporal_plane.models.RecallEntry` objects
