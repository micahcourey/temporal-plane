...
│   └── snapshots/
├── docs/
│   ├── temporal-plane-plan-v3.md
│   ├── temporal-plane-roadmap.md
...
## 3.2 Why add `temporal-plane-types`
...
If that feels premature, it can start folded into `temporal-plane-core` and be extracted later.

## 3.3 Why add `temporal-plane-test-support`
...
This adapter should translate host concepts into Temporal Plane concepts without creating a second memory system.

---

## 6. Initial Internal Module Scaffold

## 6.1 `temporal-plane-core/src/`
...
## 6.2 `temporal-plane-lancedb/src/`
...
- no `lancedb` dependency in `temporal-plane-core`
...
**Goal:** implement the product behavior that differentiates Temporal Plane from a simple searchable store.
...
Temporal Plane v1 should be considered complete when all of the following are true:
...
- `crates/temporal-plane-core/Cargo.toml`
- `crates/temporal-plane-core/src/lib.rs`
- `crates/temporal-plane-core/src/errors.rs`
- `crates/temporal-plane-core/src/ids.rs`
- `crates/temporal-plane-core/src/memory.rs`
- `crates/temporal-plane-core/src/query.rs`
- `crates/temporal-plane-core/src/traits.rs`

### Backend crate

- `crates/temporal-plane-lancedb/Cargo.toml`
- `crates/temporal-plane-lancedb/src/lib.rs`
- `crates/temporal-plane-lancedb/src/backend.rs`
- `crates/temporal-plane-lancedb/src/schema.rs`
- `crates/temporal-plane-lancedb/src/versions.rs`
- `crates/temporal-plane-lancedb/src/tags.rs`

### CLI crate

- `crates/temporal-plane-cli/Cargo.toml`
- `crates/temporal-plane-cli/src/main.rs`
- `crates/temporal-plane-cli/src/cli.rs`
- `crates/temporal-plane-cli/src/cmd/init.rs`
- `crates/temporal-plane-cli/src/cmd/search.rs`
- `crates/temporal-plane-cli/src/cmd/show.rs`
...
The implementation roadmap should keep Temporal Plane disciplined:
