...
//!
//! This crate owns the storage-agnostic product model for Temporal Plane.
...
//! }
//!
//! let scope = ScopeId::try_from("repo:temporal-plane")?;
...
//!         temporal_plane_core::CheckpointName::try_from("milestone-1-freeze")?,
