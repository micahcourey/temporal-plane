...
/// A durable memory record stored by Mnemix.
...
mod tests {
    ...
    fn base_builder() -> MemoryRecordBuilder {
        MemoryRecord::builder(
            ...
            ScopeId::try_from("repo:mnemix").expect("valid scope"),
    ...
    fn metadata_and_sources_are_preserved() {
        let record = base_builder()
            ...
            .source_ref(SourceRef::try_from("docs/mnemix-plan-v3.md").expect("source ref"))
